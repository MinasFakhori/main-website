      ...
      return (
          ...
          <div className='gridP'>
                       <First  onClick={() => openPopup("index")}className="cellP" ><BsThreeDots size="5em"/></First>
                        <Second onClick={() => openInNewTab("clone/tesla/")} className="cellP"><Text>Tesla clone website</Text><Img src = "tesla.png"/></Second>
                        <Thrid onClick={() => openInNewTab("clone/apple/")} className="cellP"><Text>Apple clone website</Text><Img src = "apple.png"/></Thrid>
          </div>
          </Wrapper>);
}
