      ...
      return (
          ...
          <div className='gridP'>
                       <First  onClick={() => openPopup("index")}className="cellP" ><BsThreeDots size="5em"/></First>
                        <Second onClick={() => openInNewTab("react/counter/")} className="cellP"><Text>Counter</Text><Img src = "counter.png"/></Second>
                        <Thrid onClick={() => openInNewTab("react/movie/")} className="cellP"><Text>Movie app</Text><Img src = "movie.png"/></Thrid>
