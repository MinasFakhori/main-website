...
//Default true because dark is default
  ...
  const slides  = [
    {name :"one" , url : "https://i.picsum.photos/id/1018/1000/600.jpg?hmac=8y6PgnvgTLEEW-118lVn6V6zPUVSN9JSi27GSpmGpdQ", id : 0  },
    {name :"two" , url : "https://www.w3schools.com/howto/img_mountains_wide.jpg" , id:1  },
    {name :"three" , url : "https://www.w3schools.com/howto/img_snow_wide.jpg" , id : 2 },
]
 ...
 let navItemP =  [
  ...
  return(
    <div className="App">
        ...
        <div id = "projects" className = "section" ref = {projectsV}>
          <ProjectsDiv>
